...
android {
    namespace = "com.trueshine.threadsposter"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.trueshine.threadsposter"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
    ...
    signingConfigs {
        create("release") {
            ...
            if (propsFile.exists()) {
                ...
                storePassword = "threadsposter"
                keyAlias = "threadsposter"
                keyPassword = "threadsposter"
            }
        }
    }
