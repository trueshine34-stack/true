...
class SecretStore(context: Context) {
    ...
    companion object {
        const val PREFS_NAME = "threadsposter_secrets"
        private const val ANDROID_KEYSTORE = "AndroidKeyStore"
        private const val KEY_ALIAS = "threadsposter_master_key"
        private const val TRANSFORMATION = "AES/GCM/NoPadding"

        const val DEEPSEEK_API_KEY = "deepseek_api_key"
        const val META_APP_SECRET = "meta_app_secret"

        fun accountTokenRef(accountId: Long) = "threads_token_$accountId"
    }
}
