...
object Time {
    ...
    /**
     * Threads отдаёт время в виде 2026-08-12T09:34:00+0000 — без двоеточия в
     * смещении, поэтому Instant.parse на нём спотыкается.
     */
    fun parseIso(value: String?): Long? {
        ...
        runCatching {
            return java.time.OffsetDateTime
                .parse(value, DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ssZ"))
