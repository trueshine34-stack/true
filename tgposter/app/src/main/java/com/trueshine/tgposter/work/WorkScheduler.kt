...
class WorkScheduler(context: Context) {
    ...
    /** Немедленный проход планировщика — после изменения настроек или по кнопке. */
    fun runAutopilotNow() {
    ...
    companion object {
        const val AUTOPILOT_WORK = "tgposter_autopilot"
        const val AUTOPILOT_NOW_WORK = "tgposter_autopilot_now"
