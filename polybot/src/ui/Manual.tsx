    ...
    <div className="card tight">
      ...
      <div className="counterrule muted">
        ...
        {state.inside ? (
          ...
          сама называет направление. И минутная тоже должна её назвать: если на
          карточке «вбок» — направления нет, окно пропускается с «нет линии».
          Раньше в этом случае бралась сторона по наклону линии, и бот покупал
          вверх, объясняя это трендом, которого на его же карточке не было.
          Отбой от уровня при молчащей линии по-прежнему работает — он читается
          по уровням, а не по ней.
          Уровнями считает все цены, от которых рынок разворачивался больше
          одного раза — и на минутном графике, и на пятиминутном за четыре
          часа, а не только те три линии, что рисуются на экране: раньше две
          из этих трёх занимал ближайший разворот, случившийся один раз, их
          же правило и отбрасывало, и до входа доходила одна стена из
          нескольких.
          Держит до уровня: как только цена дошла до стены, ради которой
          сделка бралась, продаёт прямо там и не ждёт ступени — ход
          закончился, а от цены, где рынок уже разворачивался, он обычно
          разворачивается снова. Только в плюс: позиция в минусе у стены —
          это ошибка в стороне, и платить за неё спред нет смысла, расчёт
