    ...
    <div className="card tight">
      ...
      <div className="counterrule muted">
        ...
        {state.inside ? (
          ...
          Останавливают вход две вещи, и обе — про закрывающуюся пятиминутку.
          Первая: если её размах втрое больше среднего за последний час и она
          идёт в нашу сторону — не входим. Свеча такого размера это не тренд, а
          реакция: прострел, ликвидации, новость, — и пока она закрывалась,
          сторону уже переоценили под неё; покупается ход, который уже
          состоялся, по цене, которую он и сделал. Вторая: если эта свеча
          дотянулась до уровня впереди и закрылась обратно от него — то есть
          рынок в предыдущие пять минут туда сходил и его вернули. Уровни при
          этом сторону не выбирают, они только запрещают: покупать туда значит
          просить следующие пять минут сделать то, на чём предыдущие только что
          споткнулись, от того же места.{' '}
          Ни круглые числа, ни хвост свечи вход не останавливают —
          они по очереди отсеивали окна и ни одно из них не отделяло
          выигрышные от проигрышных. Уровни всё ещё считаются за целые сутки,
          раз в минуту, только с добавлением новых, так что линии не прыгают, —
          но нужны они теперь для графика, а не для того, чтобы решать, куда
          входить. Всё, что наторгует, ниже по окнам.
          </>
        )}
      </div>
      )}
