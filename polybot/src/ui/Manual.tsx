    ...
    <div className="card tight">
      ...
      <div className="counterrule muted">
        ...
        {'После выигранного окна ставит следующую на четверть выигрыша больше, ' +
          ...
          'Если позиция падала ниже 20¢, забирает её при первом же возврате ' +
          'выше 40¢, не дожидаясь ступени. '}
        ...
        рынку, если сторона не дороже 56¢, иначе оставляет заявку по 54¢ и
        ждёт, пока цена сама придёт. Выходит обычной лесенкой продаж — той, на
