  ...
  return (
    <div className="card tight">
      ...
      <div className="counterrule muted">
        ...
        плюсе. Если цена полминуты не выходит из пяти центов — забирает при
        +20%; если полминуты простояла в минусе — при первом же +10%, но только
        когда ход уже закончился. А пока
