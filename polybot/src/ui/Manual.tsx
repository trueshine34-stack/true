    ...
    <div className="card tight">
      ...
      <div className="counterrule muted">
        ...
        {state.inside ? (
          ...
          окон. Что лесенка не продала — забирает расчёт.{' '}
          ...
          сторону не выбирают. Из уровней вход останавливают только круглые
          пятьсот — 88 000, 88 500, 89 000 — если окно открывается ближе{' '}
          ...
          Уровни считаются за целые сутки, раз в минуту, только с добавлением
          новых, так что линии не прыгают — но нужны они теперь для графика, а
          не для того, чтобы решать, куда входить. Всё, что наторгует, ниже по
          окнам.
          </>
        )}
      </div>
